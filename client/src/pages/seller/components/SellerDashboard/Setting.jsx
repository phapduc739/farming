            ...
            <div className="w-full h-[100%]  bg-them-gray flex  flex-wrap px-8 py-8  ">
                ...
                <div className=" w-full h-[auto]     rounded-md">
                    ...
                    <div className="  rounded-md relative bg-white px-4 py-4 mt-4">
                        ...
                        <button className="btn theme-bg-color btn-md fw-bold mt-4 text-white bg-theme-color rounded-md">Lưu Thay Đổi</button>
                    </div>
                    ...
                    <div className="rounded-md relative bg-white px-4 py-4 mt-4">
                        <div className="">
                            ...
                            <button className="btn theme-bg-color btn-md fw-bold mt-4 text-white bg-theme-color rounded-md">Vô hiệu hóa Tài khoản</button>
                        </div>
                    </div>
                    ...
                    <div className="rounded-md relative bg-white px-4 py-4 mt-4">
                        <div className="dashboard-bg-box">
                            ...
                            <button className="btn theme-bg-color btn-md fw-bold mt-4 text-white bg-theme-color rounded-md">Xóa tài khoản</button>
                        </div>
                    </div>
                </div>
            </div >
