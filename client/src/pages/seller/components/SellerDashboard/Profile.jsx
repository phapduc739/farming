                ...
                <div className=" w-full h-[auto]    rounded-md">
                    <div className="tab-content " id="pills-tabContent">
                        <div className="dashboard-home flex flex-col">
                            <div className="title relative">
                                <h2 className="text-[21px] font-bold  relative ">Thông tin </h2>
                    ...
                    <div className=" px-4 py-4 profile-tab  relative  bg-white">
                        <div className="dashboard-title flex justify-between items-center px-4 ">
                            ...
                            <button className="btn-sm py-2 px-4 text-base font-medium bg-theme-color text-white" data-bs-toggle="modal" data-bs-target="#chinh-sua-ho-so" onClick={openEditModal}>Chỉnh Sửa Hồ Sơ</button>
                        </div>
