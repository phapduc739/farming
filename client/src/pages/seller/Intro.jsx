...
export default function Intro() {
  ...
  return (
    <>
        ...
        <div className="container-fluid-lg">
          <div className="row w-[100%] mx-[-12px] mt-1 mb-2 bg-white">
            <div className="row w-full mx-0 relative">
              <h1 className="text-center font-mono leading-normal text-theme-color text-4xl font-normal">
              ...
              <div className="grid grid-cols-2 gap-4 mt-6">
                ...
                <div className="mt-3 ml-3 relative">
                  ...
                  <p className="text-base font-normal pb-3">
                    Cửa hàng Nông Sản Sạch - FamertMaket.Com, là trang web cung
                    cấp thực phẩm an toàn, hoàn toàn tự nhiên, và nông sản sạch
                    cho mọi gia đình. Chúng tôi cam kết mang đến thực phẩm an
                    toàn tới mọi gia đình Việt Nam. Các sản phẩm nổi bật bao
                    gồm: trà, ngũ cốc dinh dưỡng, hạt dinh dưỡng, trái cây sấy,
                    và nhiều sản phẩm khác.
                  </p>
                  <p className="text-base font-normal pb-3">
                    Chúng tôi hướng đến mục tiêu xây dựng một cuộc sống an toàn
                    và chất lượng cho cộng đồng tại Việt Nam. Hãy cùng nhau đồng
                    lòng, chung tay xây dựng một cuộc sống an lành, bền vững cho
                    mọi người.
                  </p>
      ...
      <section className=" py-10 bg-theme-color ">
        <div className="container-fluid-lg">
          <div className="row w-[100%] mx-[-12px] mt-1 mb-2">
            ...
            <div className="grid grid-cols-3 gap-4 mt-6">
              <div className="flex items-center gap-2  flex-col">
                <div className="relative  mb-3">
                  <div className="absolute top-1/2 transform -translate-y-1/2 ">
                    <div className="bg-white rounded-full py-1 px-1.5 hover:bg-theme-color">
                      <i className="fa-regular fa-heart text-4xl"></i>
                    </div>
                  </div>
                  <div className="pl-[60px] pr-12 py-3">
                    <h6 className="text-[18px] font-[500] leading-[1.5]">
                      Dinh dưỡng cải thiện hơn.
                    </h6>
                    <p className="text-[14px] font-[400]">
                      Cải thiện chế độ ăn uống với sự đa dạng hơn trong loại
                      trái cây và rau quả hàng ngày.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative  mb-3">
                  ...
                  <div className="pl-[60px] pr-12 py-3">
                    ...
                    <p className="text-[14px] font-[400]">
                      Cam kết cung cấp nông sản hữu cơ an toàn, đảm bảo chất
                      lượng và nguồn gốc rõ ràng.
                    </p>
                  </div>
                </div>
                <div className="relative  mb-3">
                  ...
                  <div className="pl-[60px] pr-[12px] py-3">
                    ...
                    <p className="text-[14px] font-[400]">
                      Với việc trồng không sử dụng hóa chất độc hại, nông sản
                      sạch đảm bảo chất lượng và an toàn cho sức khỏe của bạn.
                    </p>
                  </div>
                </div>
              </div>
              <div className="flex items-center justify-center">
                <img
                  src={BgNs}
                  className="w-[350px] h-[350px] bg-transparent"
                />
              </div>
              <div className="flex flex-col items-end gap-2">
                <div className="relative  mb-3">
                  <div className="pr-[60px] pl-[12px] py-3">
                    ...
                    <p className="text-[14px] font-[400]">
                      Tinh chỉnh phương pháp giao hàng chuẩn để loại bỏ các sản
                      phẩm không phù hợp.
                    </p>
                  </div>
                ...
                <div className="relative  mb-3">
                  <div className="pr-[60px] pl-[12px] py-3">
                    ...
                    <p className="text-[14px] font-[400]">
                      Mỗi lần mua nông sản sạch, bạn đang hỗ trợ người nông dân
                      địa phương - một cách cộng đồng và bền vững.
                    </p>
                  </div>
                  <div className="absolute top-1/2 transform -translate-y-1/2 mr-0.5 right-0">
                    <div className="bg-white rounded-full py-1 px-1.5 hover:bg-theme-color">
                ...
                <div className="relative  mb-3">
                  <div className="pr-[60px] pl-[12px] py-3">
                    ...
                    <p className="text-[14px] font-[400]">
                      Với phương pháp trồng hữu cơ, chúng ta chú trọng đến việc
                      bảo vệ môi trường thông qua việc giảm sử dụng hóa chất và
                      duy trì chất lượng nước, mang lại sản phẩm an toàn và bền
                      vững.
                    </p>
                  </div>
                  <div className="absolute top-1/2 transform -translate-y-1/2 mr-0.5 right-0">
          ...
          <div className="row w-[100%] mx-[-12px] mt-1 mb-2 bg-white">
            ...
            <div className="grid grid-cols-3 gap-4 mt-4 ">
              <div className="flex items-center flex-col">
                <div>
                  <img className="w-[400px] h-[250px]" src={BgCh1} />
                </div>
                <div className="ml-4">
                  ...
                  <ul className="flex">
                    <li className="relative rounded-full mx-1 h-10 w-10 leading-10 text-gray-400 border border-gray-400 text-center flex items-center justify-center transition duration-300 hover:bg-green-200 group">
                      ...
                      <span className="opacity-0 group-hover:opacity-100 absolute bg-gray-300 text-white text-xs py-1 px-2 rounded top-0 mt-8 transition duration-300">
                        Facebook
                      </span>
                    </li>
                    ...
                    <li className="relative rounded-full mx-1 h-10 w-10 leading-10 text-gray-400 border border-gray-400 text-center flex items-center justify-center transition duration-300 hover:bg-theme-color group">
              ...
              <div className="flex items-center flex-col">
                <div>
                  <img className="w-[400px] h-[250px]" src={BgCh2} />
                </div>
                <div className="ml-4">
                  <h6 className="text-center py-4 text-[18px]  font-semibold">
                    Hồ Chính Minh
              ...
              <div className="flex items-center flex-col">
                <div>
                  <img className="w-[400px] h-[250px]" src={BgCh3} />
                </div>
                <div className="ml-4">
                  <h6 className="text-center py-4 text-[18px]  font-semibold">
                    Cần Thơ
